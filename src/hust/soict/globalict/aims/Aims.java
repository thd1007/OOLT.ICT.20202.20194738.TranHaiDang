...
public class Aims {
	...
	{
		System.out.print("Input type of media: ");
	...
	public static void deleteItemAdmin()
	{
		System.out.print("Input item ID (number only): ");
		int id = scanner.nextInt();
		boolean ok = false;
	...
	public static void displayItemAdmin()
	{
		for (int i = 0; i < Storage.size(); ++i)
		{
			Media x = Storage.get(i);
